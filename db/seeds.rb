...
Wine.create!([
  ...
  {name: "Italian Sangiovese", country: "Italy", grape: "Sangiovese",color: "red", description: "Sangiovese is often depcited as a powerhouse grape, but traditional Chianti producers like Castello di Volpaia refrain from blending naturally light-bodied, red-fruited Sangiovese with fleshier grapes."},
