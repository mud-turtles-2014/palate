...
Wine.create!([
  ...
  {name: "French Cabernet Sauvignon", country: "France", grape: "Cabernet Sauvignon",color: "red", description: "Cabernet Sauvignon dominates blends in the Left Bank of Bordeaux, the region famous for the Haut-Medoc and its first growths. Cotes de Bordeaux wines with mostly Cabernet Sauvignon will express the region well, too."},
  ...
  {name: "French Merlot", country: "France", grape: "Merlot", color: "red", description: "Merlot dominates blends in the Right Bank of Bordeaux. Cotes de Bordeaux wines with mostly Merlot also express the grape well."},
  {name: "French Pinot Noir", country: "France", grape: "Pinot Noir", color: "red", description: "The minute holdings in Burgundy, painstakingly divided by plot, are a testament to the French idea of terroir, valuing land and grapes over winemaking techniques in the cellar."},
  {name: "French Syrah", country: "France", grape: "Syrah/Shiraz", color: "red", description: "Syrah is known for the herbal garrigue notes it picks up from its mediterranean surroundings. A wine from St. Joseph or Hermitage express the grape at its peak. Crozes Hermitage bottlings, from the lower lying area around the elevated Hermitage region are an excellent second choice."},
  # whites
